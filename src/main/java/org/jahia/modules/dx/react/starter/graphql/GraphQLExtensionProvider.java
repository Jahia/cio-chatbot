...
public class GraphQLExtensionProvider implements DXGraphQLExtensionsProvider {
    ...
    public Collection<Class<?>> getExtensions() {
        ...
        extensions.add(org.jahia.modules.dx.react.starter.graphql.queries.assistant.WatsonQueryExtension.class);
        extensions.add(org.jahia.modules.dx.react.starter.graphql.queries.catalog.CatalogQueryExtension.class);
